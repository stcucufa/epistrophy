...
export class Scheduler extends EventTarget {
    ...
    // Reschedule a fiber, if it was previously scheduled for a later instant.
...
export class Fiber {
    ...
    static Ops = {
        ...
        // joins. Previous children are not affected. The join delegate is a
        // single function to distinguish from a regular join.
        seq(scheduler, child) {
