    ...
    static Ops = {
        ...
        delay(dur) {
            ...
            if (effectiveDuration === Instant) {
                effectiveDuration = (this.scheduler.end - this.scheduler.now) * this.effectiveRate;
            }
...
export class ScheduledFiber {
    ...
    cancel() {
        ...
        if (!this.handlesErrors) {
            ...
            if (this.delay) {
                this.now += ((this.scheduler.now ?? this.scheduler.clock.now) - this.delay.observedBegin) / this.effectiveRate;
                delete this.delay;
            }
            return true;
        }
