...
export default class Fiber {
    ...
    exec(f) {
        return this.#push(isAsync(f) ? function(scheduler) {
    ...
    event(target, type, delegate = {}) {
        return this.#push(function(scheduler) {
    ...
    repeat(f, delegate = {}, joinDelegate = Single) {
        return this.
            spawn(fiber => {
                fiber.ops.push(function() {
                ...
                const begin = fiber.ops.length;
                fiber.ops.push(function(scheduler) {
                    if (!this.handleResult ||
