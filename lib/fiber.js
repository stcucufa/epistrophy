...
export default class Fiber {
    ...
    repeat(f, delegate = {}) {
        const body = new Fiber().
            ...
            op(function(scheduler) {
                ...
                const { unops, now, ownRate, parent } = this;
                this.parent.unops.push(function(scheduler) {
                    delete this.endTime;
                    scheduler.unjoinFiber(parent, Object.assign(this, {
                        unip: unops.length, unops, now, ownRate, rate: parent.rate * this.ownRate
                    }));
                });
        ...
        return this.op(function(scheduler) {
            ...
            const instance = this.child = body.instantiate({ parent: this });
            scheduler.resetFiber(this.child);
            scheduler.resumeFiber(this.child);
            this.yielded = true;
            this.unops.push(function(scheduler) { scheduler.unattachFiber(instance); });
    ...
    spawn(f) {
        ...
        this.ops.push(function(scheduler) {
            if (this.handleResult) {
                const instance = child.instantiate();
