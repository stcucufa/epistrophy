...
export default class Fiber {
    ...
    // Wait for `dur`ms, unless the fiber is failing. If dur is a function, then
    // call it with `fiber` and `scheduler` as argument and use the return value
    // as the delay duration. There is no effect if dur is zero or less. The
