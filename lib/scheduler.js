import { create, extend, mapit } from "./util.js";
import { show } from "./show.js";
import { Queue } from "./priority-queue.js";
import * as time from "./time.js";

// Ops have three behaviours depending on whether we are in do, undo or redo
// execution mode (plus Dur for the timeline).
export const [Do, Undo, Redo, Dur] = [0, 1, 2, 3];
...
const proto = {
    ...
    dump() {
        ...
        return `[${mapit(this.futureQueue.values(), item)}] // [${mapit(this.pastQueue.values(), item)}]`;
    }
};
