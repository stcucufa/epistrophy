...
const proto = {
    ...
    unpackScheduleItem(scheduleItem) {
        ...
        console.log(`>>> #${scheduleItem.thread.spawnID} (${scheduleItem.thread.id})`, scheduleItem);
    },
    ...
    spawnChild(thread) {
        thread.begin = this.t;
        thread.spawnID = this.spawnID++;
        this.scheduler.scheduleForward(thread, this.t, 0, this.value);
        console.log(`Spawn child thread #${thread.spawnID} (${thread.id})`);
    },
