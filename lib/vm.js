...
import { create, get, geto } from "./util.js";
...
const proto = {
    ...
    unpackScheduleItem(scheduleItem) {
        ...
        notify(this, "unpack", { scheduleItem });
    },
    ...
    // TODO options (preventDefault, stopImmediatePropagation, stopPropagation)
    listen(thread, target, type) {
