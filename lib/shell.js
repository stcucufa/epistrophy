...
// Fail the fiber with the given error.
Fiber.prototype.fail = function(error) {
    return this.call(fiber => { fiber.fail(error); });
};

ScheduledFiber.prototype.fail = function(error) {
    this.errorWithMessage(error ?? Error());
};
...
// A result is either an error or a value.
Object.defineProperty(ScheduledFiber.prototype, "result", {
    enumerable: true,
    get() {
