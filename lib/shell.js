...
Fiber.prototype.repeat = function(f, delegate) {
    ...
    this.
        call(fiber) => {
            if (instance.repeatShouldEnd?.call(instance, 0, fiber)) {
                return;
            }
        ...
        join({
            ...
            childFiberDidJoin(child) {
                ...
                instance.childFiberDidJoin?.call(instance, child);
                ...
                if ((fiber.error && !fiber.handlesErrors) ||
                    instance.repeatShouldEnd?.call(instance, this.i, fiber)) {
                    return true;
                }
                this.child = scheduler.attachFiber(fiber, body);
            }
        })
