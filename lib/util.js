...
// Dispatch a custom event from `this` (use call).
export function customEvent(type, detail) {
...
// Create elements with an optional dictionary of attributes and content (other
// elements, arrays of content, or text). Use a null namespace for HTML.
...
// Create HTML and SVG elements with the right namespace.
...
export const timeout = async dur => new Promise(resolve => { window.setTimeout(resolve, dur); });
