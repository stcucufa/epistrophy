...
// Create HTML elements with an optional dictionary of attributes and content
// (other HTML elements, arrays of content, or text).
...
// Format a time offset as clock value (h:mm:ss.ms).
