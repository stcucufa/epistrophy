import { nop, on, PriorityQueue, parseOffsetValue } from "./util.js";
...
export class Fiber {
    ...
    // Add a ramp to the fiber with the given duration and callback.
    ramp(dur, f = nop) {
        this.ops.push(["beginRamp", dur, f]);
        this.ops.push(["endRamp", f]);
        return this;
    }
